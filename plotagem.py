...
directory_path = current_path + "/graficos_gerados_csv/edfa2/"
...
dic = {
            ...
            '1_span_90_40': ['1_spans_90.0 Km_edfa2_mask_model40ch.csv', '1_spans_90.0 Km_edfa2_AdvancedModel40ch.csv' ],
            '1_span_90_80': ['1_spans_90.0 Km_edfa2_mask_model80ch.csv', '1_spans_90.0 Km_edfa2_AdvancedModel80ch.csv'],
            '1_span_110_40': ['1_spans_110.0 Km_edfa2_mask_model40ch.csv', '1_spans_110.0 Km_edfa2_AdvancedModel40ch.csv'],
            '1_span_110_80': ['1_spans_110.0 Km_edfa2_mask_model80ch.csv', '1_spans_110.0 Km_edfa2_AdvancedModel80ch.csv'],
            '4_span_90_40': ['4_spans_90.0 Km_edfa2_mask_model40ch.csv', '4_spans_90.0 Km_edfa2_AdvancedModel40ch.csv'],
            '4_span_90_80': ['4_spans_90.0 Km_edfa2_mask_model80ch.csv', '4_spans_90.0 Km_edfa2_AdvancedModel80ch.csv'],
            '4_span_110_40': ['4_spans_110.0 Km_edfa2_mask_model40ch.csv', '4_spans_110.0 Km_edfa2_AdvancedModel40ch.csv'],
            '4_span_110_80': ['4_spans_110.0 Km_edfa2_mask_model80ch.csv', '4_spans_110.0 Km_edfa2_AdvancedModel80ch.csv']
        }
